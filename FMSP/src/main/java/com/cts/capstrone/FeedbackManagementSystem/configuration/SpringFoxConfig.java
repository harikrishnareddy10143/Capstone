 ...
 * .paths(PathSelectors.ant("/reactive/streams/**")) .build(); } private ApiInfo
 * apiInfo() { return new ApiInfoBuilder() .title("Reactive STream Stater Demo")
 * .description("xyz") .version("2") .build(); } }
 */